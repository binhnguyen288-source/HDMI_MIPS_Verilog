...
## Pmod Header JC
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD TMDS_33 } [get_ports { TMDSpred }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD TMDS_33 } [get_ports { TMDSnred }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD TMDS_33 } [get_ports { TMDSpgreen }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD TMDS_33 } [get_ports { TMDSngreen }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD TMDS_33 } [get_ports { TMDSpblue }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
#set_property -dict { PACKAGE_PIN V14   IOSTANDARD TMDS_33 } [get_ports { TMDSnblue }]; #IO_L22N_T3_A04_D20_14 Sch=jc_n[3]
