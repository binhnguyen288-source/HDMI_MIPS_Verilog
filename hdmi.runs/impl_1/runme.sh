...
HD_PWD='C:/Users/nguye/Documents/rever/HDMI_MIPS_Verilog/hdmi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi.tcl -notrace
